...
qnn_model_name = "test.mat";
path_to_data = "/home/magody/programming/MATLAB/tesis/Data/preprocessing/"; 

qnn_model = load(qnn_model_name);

packet_data = orderfields(dir(path_to_data));
packet_data_size = length(packet_data);

%%
for k=3:packet_data_size
    user_folder = path_to_data + "user" + (k-2) + "/userData.mat";
    user_data = load(user_folder);
...
%{
        ...
        % ============================== SPECIFIC ===================================
        name_indices='indicesTodosExp1S.mat';
        save('indicesTodosExp1S.mat','Location','indices','gestureLocation')
        % ============================== Check sensor placement =====================
        [~,users_good_checked,~] = Wmoos_check_sensor_placement_training(name_indices,'NR',1);
        assignin('base','users_good_checked',users_good_checked);    
        % ============================== Packing EMG Data ===========================
        fprintf('\nPacking all EMG Data ...\n');    
        ventana=180;
        [trainActivity,Ms1,Ms2,Ms3,Ms4,Ms5,Ms6,Ms7,Ms8] = Wmoos_data_union_train(ventana,name_indices,'NC','NR');
        ...
        for i=1:(size(sEMGActivityDataRandom))*[1;0]
            ...
            dataTable=sEMGActivityDataRandom{i,2};        
                ...
                load('userData.mat')                
                if i==1
                folder=[pwd,'/','Data/Trained_Specific_Exp1','/',char(sEMGActivityDataRandom{i,1})];
                else
                folder=['Trained_Specific_Exp1','/',char(sEMGActivityDataRandom{i,1})];
                end
                mkdir (folder)
                cd (folder)
                save('userData.mat','classifierSVM','dataTable','name') 
...
% ==================================================================================
    ...
    elseif modelSelected =="specific"
        ...
        % Variables to select classifier model sequence 
        assignin('base','sequence_mad', true);   % Takes MAD
        ...
        addpath('Data/Trained_Specific_Exp1');
        
        
        dataPacket_aux      = orderfields(dir('Data/Trained_Specific_Exp1'));
        pathOrigin_aux      = 'Data/Trained_Specific_Exp1';
        pathUser_aux        = pwd;
        ...
        while testControl==true
            ...
            if userIndex>=3 && change_user==false
                ...
                folder_main       = 'Data/Trained_Specific_Exp1';
                ...
                emgDataTested           = OfflineDataExp1S(1,20,"off");    
                emgFeatured             = getFeatures(emgDataTested);
                emgTarget               = getClassification(emgFeatured,"offline");
                emgTargetPostprocessed  = getTargetPostprocessed(emgTarget,"offline");
        ...
        fileName='responseExp1S.mat';        
        save( fileName,'response');        
        zero_analysis = start_at-150;
        WM_conversion_newFormat(fileName,zero_analysis)
        
        jsonName='responseExp1S.json';
        jsonFormat(fileName,jsonName);   
        
        exitCheck=true;
        delete(pwd,'/','indicesTodosExp1S.mat')        
