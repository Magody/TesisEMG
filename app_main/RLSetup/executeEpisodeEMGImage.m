function history_episode = executeEpisodeEMGImage(q_neural_network, episode, is_test, functionGetReward, context, verbose_level) 
    ...
    merge = image_config.merge;
    
    emg = transformEMGToImage(emg, height, width, merge);
