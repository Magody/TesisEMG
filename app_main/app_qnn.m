...
%% Libs
path_to_framework = "C:\Users\Magody\Documents\GitHub\MATLABMagodyFramework\magody_framework"; %"/home/magody/programming/MATLAB/deep_learning_from_scratch/magody_framework";
data_dir = 'C:\Users\Magody\Documents\GitHub\TesisEMG\Data\preprocessing\'; % '/home/magody/programming/MATLAB/tesis/Data/';
...
prepare_environment(data_dir, verbose_level-1);
...
q_neural_network = QNeuralNetwork(sequential_conv_network, sequential_network, ...
                    nnConfig, qLearningConfig, @executeEpisodeEMGNN);    % @executeEpisodeEMGImage 

q_neural_network.setCustomRunEpisodes(@customRunEpisodesEMGNN);
